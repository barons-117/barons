...
export default function TripDetail(){
  ...
  return(
    <div style={P.page}>
        ...
        subtitle={`${fmtShort(startDate)} – ${fmtShort(endDate)} · ${trip?.countries?.join(', ') || ''}`}
        breadcrumbs={[{ label: 'נסיעות', path: '/travels' }, { label: trip?.name || '...' }]}
        actions={[{ label: '✎ עריכה', onClick: () => setShowEdit(true) }, { label: '+ סגמנט', onClick: () => setShowAdd(true), primary: true }]}
      />
