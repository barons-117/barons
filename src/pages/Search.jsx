    ...
    <div style={S.page}>
      <header style={S.header}>
        <nav style={{display:'flex',alignItems:'center',gap:'6px',fontSize:'13px',color:'#64748b'}}>
          <button style={S.crumb} onClick={()=>navigate('/')}>BARONS</button>
          <span style={{color:'#cbd5e1'}}>/</span>
          <button style={S.crumb} onClick={()=>navigate('/travels')}>נסיעות</button>
          <span style={{color:'#cbd5e1'}}>/</span>
          <span style={{color:'#1e293b',fontWeight:600}}>חיפוש מתקדם</span>
        </nav>
