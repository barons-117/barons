    ...
    <div style={S.page}>
      <header style={S.header}>
        <nav style={{display:'flex',alignItems:'center',gap:'6px',fontSize:'13px',color:'#64748b'}}>
          <button style={{background:'none',border:'none',color:'#1d4ed8',fontSize:'13px',fontWeight:600,cursor:'pointer',padding:'2px 0'}} onClick={()=>navigate('/')}>BARONS</button>
          <span style={{color:'#cbd5e1'}}>/</span>
          <button style={{background:'none',border:'none',color:'#1d4ed8',fontSize:'13px',fontWeight:600,cursor:'pointer',padding:'2px 0'}} onClick={()=>navigate('/travels')}>נסיעות</button>
          <span style={{color:'#cbd5e1'}}>/</span>
          <span style={{color:'#1e293b',fontWeight:600}}>סטטיסטיקות</span>
        </nav>
